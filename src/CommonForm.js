...
function CommonForm() {
    ...
    return (
        <>
            <div className="pad80 grey conversation-wrapper">
                <Container>
                    <div className="wow fadeInUp">
                        <h2 className="text-center h4 ">Get in touch</h2>
                    </div>
                    <Form onSubmit={handleSubmit(onSubmit)} method="post">
                        <Row>
                            <Col md={6}>
                                <Form.Group className="mb-3 wow fadeInUp" controlId="Name" data-wow-delay="0.2s">
                                <Form.Control
    type="text"
    placeholder="Name*"
    autoComplete="off"
...
/>
                            ...
                            <Col md={6}>
                                <Form.Group className="mb-3 wow fadeInUp me-3 d-flex w-100" controlId="formBasicEmail2" data-wow-delay="0.3s">
...
<option value="+263">+263 ZWE</option>
                            ...
                            <Col md={6}>
                                <Form.Group className="mb-3 wow fadeInUp" controlId="b_email" data-wow-delay="0.5s">
                                    <Form.Control
                                        type="text"
                            ...
                            <Col md={6}>
                                <Form.Group className="mb-3 wow fadeInUp" controlId="c_name" data-wow-delay="0.4s">
                                    <Form.Control
                                        type="text"
                            ...
                            <Col md={6}>
                                <Form.Group className="mb-3 wow fadeInUp" controlId="b_email" data-wow-delay="0.6s">
                                    <Form.Control
                                        type="text"
                            ...
                            <Col md={6}>
                                <Form.Group className="mb-3 wow fadeInUp" controlId="formBasicEmail" data-wow-delay="0.7s">
                                    <Form.Select 
                                        {...register("type", {
                                            required: {
                                              value: true,
                            ...
                            <Col md={12}>
                                <Form.Group className="mb-3  wow fadeInUp" controlId="exampleForm.ControlTextarea1" data-wow-delay="0.8s">
                                    <Form.Control
                                        as="textarea"
                                        rows={3}
                                        placeholder="Message"
                            ...
                            <Col md={12}>
                                <div className="form-check wow fadeInUp" data-wow-delay="0.9s">
                                    <input
                                        type="checkbox"
                            ...
                            <Col md={12} className="text-center wow fadeInUp" data-wow-delay="0.9s">
